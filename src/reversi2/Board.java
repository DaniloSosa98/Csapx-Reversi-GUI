...
public class Board {
     ...
     */
    private List<Observer<Board>> observers = new LinkedList<>();
     ...
     */
    public void addObserver(Observer<Board> observer){
    ...
    static EnumMap< Move, Character > cmap = new EnumMap<>( Move.class );
    ...
    private void notifyObservers(){
        for (Observer<Board> observer: observers) {
